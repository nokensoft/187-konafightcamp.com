<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
                ...
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        ...
                        <button form="send-verification" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                            <i class="fa-solid fa-paper-plane"></i> {{ __('Click here to re-send the verification email.') }}
                        </button>
                    </p>
        ...
        <div class="flex items-center gap-4">
            <x-primary-button><i class="fa-solid fa-floppy-disk"></i> {{ __('Save') }}</x-primary-button>
